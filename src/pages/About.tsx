...
const About = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col">
      <Helmet>
        <title>
          About Us - AgroInternational | Premium Agro-Products Exporter
        </title>
        <meta
          name="description"
              ...
              <div className="md:col-span-2">
                ...
                <div className="p-6 rounded-lg bg-muted/30 border-l-4 border-accent mb-6">
                  <p className="font-lato text-lg text-foreground/90 italic leading-relaxed">
                    "Our commitment goes beyond business transactions. We're
                    building lasting partnerships that empower farmers, deliver
                    exceptional quality to our clients, and contribute to a
                    sustainable agricultural future. Every product we export
